...
// ── CSS accent color → Phaser hex, so the explorer marker matches the
// active hue-slider color, same reasoning/implementation as race-scene.js's
// readBrandColor() (duplicated locally rather than imported — each scene
// file in this project is self-contained).
